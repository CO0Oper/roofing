  ...
  return <div className="site" id="top" data-direction-seed="8ada6303">
    ...
    <main>
      <section className="hero" aria-labelledby="hero-title">
        <img className="hero-image" src="/assets/dryforce-hero.png" alt="Roofing professional inspecting a rain-wet residential roof" /><span className="hero-disclosure">Illustrative concept image</span>
      ...
      <section className="field-note section"><div className="field-copy"><h2>A calmer conversation after the storm.</h2><p>Show what you’re seeing, share where it’s happening, and ask what should happen next. The goal is a useful first step—not a rushed promise.</p><a className="button button-ink" href="#contact">Tell us what happened <ArrowDown /></a></div><div className="team-image"><img src="/assets/dryforce-team.png" alt="Roofing team reviewing an inspection report with a homeowner" /><span>Illustrative concept image</span></div></section>
